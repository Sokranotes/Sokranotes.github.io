...
![Sokranotes](/assets/img/2021-07-13-博客搭建及使用说明/avatar.jpg)
...
- Images：Jekyll 镜像提供Jekyll及相关环境
- Volumes：保存VSCode会话期间的个性化设置和相关依赖。
- Containers：基于镜像创建的运行实例。
- 相关配置及脚本位于.devcontainer目录下。
## 二、本博客使用说明
...
![Obsidian Settings](/assets/img/2021-07-13-博客搭建及使用说明/Obsidian Settings.png)
```python
import shutil
...
效果：
![script work](/assets/img/2021-07-13-博客搭建及使用说明/script work.png)
